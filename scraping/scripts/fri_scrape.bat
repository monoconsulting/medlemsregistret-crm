@echo off
REM ========================================
REM FRI Bulk Scraper
REM Scrapes all FRI municipalities and saves to JSON
REM ========================================

echo.
echo ========================================
echo FRI BULK SCRAPER
echo ========================================
echo.
echo This script will scrape all FRI municipalities
