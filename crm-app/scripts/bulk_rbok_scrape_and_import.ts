/**
 * Bulk RBOK Scrape and Import (Combined)
 *
 * Runs both scraping and importing in sequence:
 * 1. Scrapes all RBOK municipalities
 * 2. Immediately imports the scraped data to database
 *
 * This is a convenience wrapper around bulk_rbok_scrape and bulk_rbok_import.
 */
...
async function main() {
  ...
  try {
    ...
    await runCommand(
      ...
      'STEP 1: SCRAPING ALL RBOK MUNICIPALITIES'
    );
