                ...
                <div className="space-y-6 pb-8">
                  ...
                  <section className="rounded-lg border bg-card p-4">
                    ...
                    <div className="mt-4 space-y-4 text-sm">
                      {association.descriptionSections.length ? (
                        association.descriptionSections.map((section) => (
                        ...
                        <p>Ingen strukturerad beskrivning tillgänglig.</p>
                      )}
                      {association.descriptionFreeText ? (
                        <div>
                          <h4 className="font-medium">Fritext</h4>
